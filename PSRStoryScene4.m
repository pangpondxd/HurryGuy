...
- (id)init
{
      self = [super init];
        ...
        // Hello world
        CCLabelTTF *label = [CCLabelTTF labelWithString:@"Sky pier"
...
//        label.position = ccp(0.5f,0.8f);
        ...
        CCLabelTTF *textStory1 = [CCLabelTTF labelWithString:@"Sky pier เป็นที่อยู่ของมังกร"
                                                       fontName:@"Chalkduster"
                                                       fontSize:18.0];
    ...
    CCLabelTTF *textStory2 = [CCLabelTTF labelWithString:@"มีอาหารมากมายบนฟ้าสำหรับมังกร"
                                                   fontName:@"Chalkduster"
                                                   fontSize:18.0];
    ...
    CCLabelTTF *textStory3 = [CCLabelTTF labelWithString:@"ต้องใช้เวลาบินกว่าจะถึง Sky pier"
                                                      fontName:@"Chalkduster"
                                                      fontSize:18.0];
    ...
    CCLabelTTF *textStory4 = [CCLabelTTF labelWithString:@"ผู้กล้ามากมายที่พยายามบินขึ้นไป"
                                                        fontName:@"Chalkduster"
                                                        fontSize:18.0];
    ...
    CCLabelTTF *textStory5 = [CCLabelTTF labelWithString:@"แต่ไม่มีผู้ใดที่พิชิตแผ่นดินนั้นได้"
                                                        fontName:@"Chalkduster"
                                                        fontSize:18.0];
    ...
    CCLabelTTF *textStory6 = [CCLabelTTF labelWithString:@"มังกรเมื่อลงมาสู่โลกมนุษย์เวลานาน"
                                                           fontName:@"Chalkduster"
                                                           fontSize:18.0];
    ...
    CCLabelTTF *textStory7 = [CCLabelTTF labelWithString:@"มังกรจะลืมทางกลับบ้านของตัวเอง"
                                                           fontName:@"Chalkduster"
                                                           fontSize:18.0];
    ...
    CCLabelTTF *textStory8 = [CCLabelTTF labelWithString:@"ดังนั้นมังกร Harry และ Garen"
                                                           fontName:@"Chalkduster"
                                                           fontSize:18.0];
    ...
    CCLabelTTF *textStory9 = [CCLabelTTF labelWithString:@"เป็นกลุ่มสุดท้ายที่จะพาไปดินแดนนั้น"
                                                           fontName:@"Chalkduster"
                                                           fontSize:18.0];
    ...
    CCLabelTTF *textStory10 = [CCLabelTTF labelWithString:@"ร่วมเป็นส่วนหนึ่งของภารกิจของเขา"
                                                           fontName:@"Chalkduster"
                                                           fontSize:18.0];
...
//          nextButton.position = ccp(0.85f, 0.1f); // Top Right of screen
